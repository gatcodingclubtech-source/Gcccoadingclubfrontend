...
import { ArrowLeft, CheckCircle2, AlertCircle, Sparkles, Shield, Code, Layers, Globe, Terminal as TerminalIcon, Users, Rocket, User as UserIcon, Mail, Book, Hash, Phone, Send, Calendar } from 'lucide-react';
            ...
            <div className="p-16 text-center flex flex-col items-center gap-10">
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="text-slate-500 font-medium max-w-md mx-auto text-lg leading-relaxed">
                  Your interest in the <span className={`font-bold text-${domain.color}-600`}>{domain.title}</span> domain has been recorded. Our team will review your profile and update your status shortly.
                </p>
              </div>
